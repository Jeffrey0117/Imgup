          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "有的！訪客單檔最大 10MB，免費會員 25MB，付費會員 50MB。支援格式：JPG、PNG、GIF、WebP（會員額外支援 SVG、BMP、ICO）。"
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "為了防止濫用，訪客每分鐘可上傳 5 張、每天 50 張；免費會員每分鐘 20 張、每天 200 張；付費會員每分鐘 60 張且無每日上限。"
                }
              },
              {
                "@type": "Question",
          ...
          <div className={styles.guideContent}>
            ...
            <section className={styles.guideSection}>
              ...
              <div className={styles.faq}>
                ...
                <h3>Q: 有檔案大小限制嗎？</h3>
                <p>A: 有的！不同身份有不同限制：<br />
                • <strong>訪客</strong>：單檔最大 10MB<br />
                • <strong>免費會員</strong>：單檔最大 25MB<br />
                • <strong>付費會員</strong>：單檔最大 50MB<br />
                支援格式：JPG、PNG、GIF、WebP（會員額外支援 SVG、BMP、ICO）</p>

                <h3>Q: 有上傳頻率限制嗎？</h3>
                <p>A: 為了防止濫用，我們設有上傳頻率限制：<br />
                • <strong>訪客</strong>：每分鐘 5 張，每天 50 張<br />
                • <strong>免費會員</strong>：每分鐘 20 張，每天 200 張<br />
                • <strong>付費會員</strong>：每分鐘 60 張，無每日上限<br />
                達到限制時會顯示剩餘等待時間。</p>
            ...
            <section className={styles.guideSection}>
              ...
              <div className={styles.faq}>
                ...
                <h3>Q: 會收集我的個人資料嗎？</h3>
                <p>A: 我們只收集必要的資訊以防止濫用：<br />
                • IP 位址（用於防止惡意上傳和 DDoS）<br />
                • 上傳時間戳記<br />
                • 檔案類型和大小<br />
                我們不會收集或追蹤您的瀏覽行為，也不會將資料出售給第三方。所有資料僅用於服務維護。</p>
              </div>
            </section>
          </div>
